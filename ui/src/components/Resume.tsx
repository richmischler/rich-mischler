    ...
    <Paper className={classes.resume}>
      <Box component="header">
        ...
        <Box component="div" marginBottom={"5px"}>
          ...
          <Typography variant="body1">
            Javascript, Typescript, Java, Python, PHP, React, Kubernetes,
            GraphQL, Terraform, Helm, Groovy, Docker, Jenkins CI/CD, AWS
            Services (AppSync, EC2, RDS, CDK, Step Functions, Lambda, Glue,
            Athena, S3, Trusted Advisor, Support, Cloudwatch, AppSync,
        ...
        <Box component="div" marginBottom={"5px"}>
          ...
          <Typography variant="subtitle1">
            ...
            International Software Testing Qualifications Board (ISTQB) Issued
            Mar 2013 Credential ID 13-CTAL-TTA-00014-USA
          </Typography>
          <Typography variant="subtitle1">
