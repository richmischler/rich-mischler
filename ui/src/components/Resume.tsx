...
export const Resume: FunctionComponent = () => {
  return (
    <Box component="header">
      ...
      <Box component="div" marginBottom={"5px"}>
      ...
      <Box component="div" marginBottom={"5px"}>
        ...
        <ListItemText inset={true}>
          Hired as a Senior Software Engineer in Test, promoted to Senior DevOps
          Engineer
        </ListItemText>
        <ListItemText inset={true}>
        ...
        <ListItemText inset={true}>
          Built and maintained React App written in PHP which is responsible for
          running all jobs related to site operations in AWS
        </ListItemText>
        <ListItemText inset={true}>
        ...
        <ListItemText inset={true}>
          Built dozens of CI/CD pipelines using jenkins, kubernetes, terraform,
          helm
        </ListItemText>
        <ListItemText inset={true}>
          Built a quota system to limit the number of ec2 instances that can be
          spun up at one time in AWS playground accounts
        </ListItemText>
        <ListItemText inset={true}>
        ...
        <ListItemText inset={true}>
          Worked on a project to produce initial performance baseline of native
          client desktop application using TestComplete during a 4 week period.
          I worked with staff personnel to come up with the appropriate
          workflows to baseline, created script routines with performance
          counters for those workflows, ran script routines and produced a
          report matrix based on the test logs, created script routines to log
          TestComplete data to excel, reviewed performance baseline with
          stakeholder for approval, and performed knowledge transfer to six
          personnel.
        </ListItemText>
        <ListItemText inset={true}>
          ...
          practices, writing automation test cases, scripting in C# / j script,
          all aspects of TestComplete functionality, performing Keyword Driven
          Testing, and fixed all broken automation scripts. ○ Project 2 (Web
          Application): I trained 1 team member on automation best practices,
          writing automation test cases and holding test case reviews, scripting
          in C# / j script, all aspects of TestComplete functionality, and
        ...
        <ListItemText inset={true}>
          ...
          in an interation including support for IE6, IE7, IE8, FF3, and Safari
          3. All testing was handled through agile and scrum software
          development methodology on 2-3 week iteration cycles. Managed the
          publication of all site content on a daily basis. Published over 1500
          pieces of content. Responsible for uploading content using HTML.
          Managed the content management database system which holds all of the
          content on the website, and was responsible for the placement of all
          right rail content and advertisement.
        </ListItemText>
